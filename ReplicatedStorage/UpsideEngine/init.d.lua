...
export type AuthorityType = "Server" | "Client"
...
export type ShadingParams = {
	...
	texture: (imageLabel: ImageLabel, position: Vector2 | Vector3) -> (),
}
...
LookTo: (self: Camera, object: StaticObject) -> nil,
}
...
Once: (self: EventEmitter, name: string, callback: () -> any) -> Connection,
--[[
...
SetRotation: (self: Particle, rotation: number) -> nil,
--[[
...
export type ProximityPrompt2D = Sprite & {
--[[
...
export type ReactiveLabel = BaseObject & {
--[[
...
SetScene: (self: StaticObject, scene: Scene) -> nil,
--[[
...
export type AuthorityService = EventEmitter & {
--[[
...
SetAuthority: (self: AuthorityService, object: BaseObject, authorityType: AuthorityType) -> nil,
--[[
...
GetAuthority: (self: AuthorityService, object: BaseObject) -> AuthorityType,
}
...
DetectCurrentDevice: (self: CrossPlatformService) -> string,
--[[
Returns the current key for a specific action based on the current device (Mobile, Gamepad, or Keyboard)
	]]
GetTargetActionKey: (self: CrossPlatformService, action: string) -> string?,
--[[
...
export type TextTagService = BaseClass & {
--[[
]]
TextTags: { },
}
